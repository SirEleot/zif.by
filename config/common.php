        ...
        */
        'meta'=> array(
            ...
            'breaking'=>[
                ...
                'keywords'=> 'Не открываются двери, открыть дверь, заклинил замок, вскрытие замков, вскрытие авто, $name, $where, вскрытие автомобильных замков, вскрытие сейфов, ремонт замков, замена замков, ремонт замков зажигания, открыть машину, открыть квартиру, сломался ключ'
            ]
        ),
        /*
        |   mail settings
