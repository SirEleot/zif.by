...
<html lang="ru">
  <head>
      ...
      <title>Вскрытие, замена и ремонт замков {{$sity}} </title>      
      <meta name="description" content="Вскрытие, замена и ремонт замков дверей, сейфов и авто в {{$where}}, срочный выезд в район. Вскроем и заменим замок быстро с наименьшими повреждениями. 📱: {{$phones[0]}}">
      <meta name="keywords" content="не открывается, открыть, вскрытие, дверь, замок, авто, зажигания, сейф, {{$sity}}, замена, ремонт">
      <link rel="stylesheet" href="{{ asset('css/vskrytie.css') }}?v=005">           
  </head>
  <body>
