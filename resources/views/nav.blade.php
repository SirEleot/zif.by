      ...
      <div class="nav-row">
        ...
        <div class="nav-menu">
          ...
          <div class="nav-menu-links" itemscope itemtype="http://www.schema.org/SiteNavigationElement" >                
              ...
              <div class="hidden">
                <a href="#" class="nav-menu-link action-link" itemprop="url">Услуги</a>
                <div class="hidden-block">
                  @foreach (Config::get('common.sities') as $key => $sity)
                    <a href="{{ route('vskrytie-zamkov',['sity'=>$key]) }}" class="hidden-block-link" itemprop="url">{{$sity['name']}}</a>                   
                  @endforeach
                </div>
              </div>
              ...
              <!-- <a href="{{ route('doors') }}" class="nav-menu-link action-link"  itemprop="url">Дубликаты ключей</a> -->
              <a href="{{ route('home') }}#contacts" class="nav-menu-link action-link"  itemprop="url">Контакты</a>
          </div>
        </div>
        <!-- <a href="{{ route('cart') }}" class="nav-menu-cart" >
            <svg width="30px" height="30px" version="1.1" viewBox="0 0 201.387 201.387" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="cart-count"><p id="cart-count"></p></div>
          </a> -->
      </div>    
  </div>
</nav>