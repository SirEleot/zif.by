...
Route::get('/catalog/{category}/', "HomeController@index"/*"Catalog\CatalogController@index"*/)->name('catalog');
Route::get('/item/{id}/', "HomeController@index"/*"Catalog\CatalogController@item"*/)->name('item');
Route::get('/cart', "HomeController@index"/*"Catalog\CatalogController@cart"*/)->name('cart');
Route::post('/sendMessage', "HomeController@index"/*"Catalog\CatalogController@order"*/)->name('order');
Route::get('/reset', "HomeController@index"/*"Catalog\CatalogController@reset"*/)->name('reset');
